...
method TestFindCelebrity1() {
  var r := findCelebrity(3);
  assert r == -1 || (0 <= r < 3 && isCelebrity(3, r));
}

method TestFindCelebrity2() {
  var r := findCelebrity(5);
  assert r == -1 || (0 <= r < 5 && isCelebrity(5, r));
}
