...
method TestConcatenate1() {
  var q1 := new CircularArray.EmptyQueue(3);
  q1.Enqueue(1);
  q1.Enqueue(2);
  var q2 := new CircularArray.EmptyQueue(2);
  q2.Enqueue(3);
  var q3 := q1.Concatenate(q2);
  assert q3.Capacity == 5;
  assert q3.Elements == [1, 2, 3];
}

method TestConcatenate2() {
  var q1 := new CircularArray.EmptyQueue(2);
  var q2 := new CircularArray.EmptyQueue(3);
  q2.Enqueue(5);
  q2.Enqueue(6);
  q2.Enqueue(7);
  var q3 := q1.Concatenate(q2);
  assert q3.Capacity == 5;
  assert q3.Elements == [5, 6, 7];
}
