...
method TestContains2() {
  var i := Interval(2.0, 4.0);
  var result := contains(i, 6.0);
  assert result == false;
}

method TestMin1() {
  var result := min(3.5, 7.2);
  assert result == 3.5;
}

method TestMin2() {
  var result := min(9.1, 2.8);
  assert result == 2.8;
}

method TestMax1() {
  var result := max(3.5, 7.2);
  assert result == 7.2;
}

method TestMax2() {
  var result := max(9.1, 2.8);
  assert result == 9.1;
}
...
method TestIntersect2() {
  var i1 := Interval(1.0, 3.0);
  var i2 := Interval(5.0, 8.0);
  var result := intersect(i1, i2);
  assert result == Interval(5.0, 3.0);
}
...
method TestUnion2() {
  ...
  var result := union(i1, i2);
  assert result == Interval(2.0, 8.0);
}
