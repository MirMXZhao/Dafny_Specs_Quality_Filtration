...
method TestLeaveCarPark1() {
  var cp := new CarPark();
  cp.carPark := {"car1", "car2"};
  cp.reservedCarPark := {"car3"};
  var success := cp.leaveCarPark("car1");
  assert success == true;
}
...
method TestLeaveCarPark2() {
  var cp := new CarPark();
  cp.carPark := {"car1"};
  cp.reservedCarPark := {"car2"};
  var success := cp.leaveCarPark("car3");
...
method TestCheckAvailability1() {
  ...
  cp.carPark := {"car1", "car2"};
  cp.reservedCarPark := {"car3"};
  var availableSpaces := cp.checkAvailability();
...
method TestMakeSubscription1() {
  var cp := new CarPark();
  cp.subscriptions := {"car1"};
  var success := cp.makeSubscription("car2");
  assert success == true;
}

method TestMakeSubscription2() {
  var cp := new CarPark();
  cp.subscriptions := {"car1", "car2", "car3"};
  var success := cp.makeSubscription("car4");
  assert success == false;
}
...
method TestEnterCarPark1() {
  var cp := new CarPark();
  cp.carPark := {"car1"};
  var success := cp.enterCarPark("car2");
  assert success == true;
}
...
method TestEnterCarPark2() {
  var cp := new CarPark();
  cp.carPark := {"car1", "car2"};
  var success := cp.enterCarPark("car1");
  assert success == false;
}
...
method TestEnterReservedCarPark1() {
  var cp := new CarPark();
  cp.weekend := true;
  cp.reservedCarPark := {"car1"};
  var success := cp.enterReservedCarPark("car2");
  assert success == true;
}
