...
method TestComputeMax1() {
  var leftTree := new Tree.Empty();
  var rightTree := new Tree.Empty();
  var tree := new Tree.Node(leftTree, 5, rightTree);
  var mx := tree.ComputeMax();
  assert mx == 5;
}

method TestComputeMax2() {
  var leftEmpty := new Tree.Empty();
  var rightEmpty := new Tree.Empty();
  var leftSubtree := new Tree.Node(leftEmpty, 3, rightEmpty);
  var rightSubtree := new Tree.Node(leftEmpty, 7, rightEmpty);
