...
method TestSocu3() {
  var r := SumOfCubes.Socu(1, 1);
  assert r == SumOfCubes.SumEmUp(1, 1);
}
...
method TestSocuFromZero3() {
  var r := SumOfCubes.SocuFromZero(1);
  assert r == SumOfCubes.SumEmUp(0, 1);
}
...
method TestGauss2() {
  var r := SumOfCubes.Gauss(0);
  assert r == SumOfCubes.GSum(0);
}
