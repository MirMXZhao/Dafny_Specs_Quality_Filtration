...
method copyArraySlice(a : array<int>, l : int, r : int) returns (ret : array<int>)
...
method mergeSortedArraySlices(a : array<int>, l : int, m : int, r : int)
  ...
  modifies a 
{
  var left := copyArraySlice(a, l, m);
  var right := copyArraySlice(a, m, r);
  var i := 0;
  var j := 0;
  var cur := l;
  ghost var old_arr := a[..];
  ...
  modifies a
{
  ...
  else { mergeSortHelper(a, 0, a.Length); }
}

method mergeSortHelper(a : array<int>, l : int, r : int)
  ensures sorted(a[l..r])
  ensures a[..l] == old(a[..l])
  ensures a[r..] == old(a[r..])
  ...
  decreases r - l
{
  if(l >= (r - 1)) {return;}
    ...
    mergeSortHelper(a, m, r);
    mergeSortedArraySlices(a, l, m, r);
    return;
  }
}